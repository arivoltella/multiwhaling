...
#### Read the data #  
#VCF1 = read.vcfR("/shared/projects/multiwhaling/multiwhaling/data/VCF_maf_LD_Pruned.5.vcf")
...
whale_snmf <- snmf(input.file= "/shared/projects/multiwhaling/multiwhaling/data/VCF_maf_LD_Pruned.5.geno", 
                   K= 1:6, repetitions = 3, project="new", entropy=T)
#show(whale_snmf)
summary(whale_snmf)

pdf(file = "/shared/projects/multiwhaling/multiwhaling/plot/Clustering/entropy_K_maf_LD_Pruned.5.pdf")
...
ggsave("/shared/projects/multiwhaling/multiwhaling/plot/Clustering/structure_maf_LD_Pruned.5.png", height = 5, width = 9)
