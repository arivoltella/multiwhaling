...
write.table(genotype_num, file = "/shared/projects/multiwhaling/multiwhaling/data/VCF_maf_LD_Pruned.5.geno", quote = F, 
...
# Eigenvalues : 
pdf("/shared/projects/multiwhaling/multiwhaling/plot/PCA/eigenvalues_all_pop_maf_LD_pruned.5.pdf")
...
eigen_pca <- read.table("/shared/projects/multiwhaling/multiwhaling/data/VCF_maf_LD_Pruned.5.pca/VCF_maf_LD_Pruned.5.eigenvalues", header = F)
...
proj <- read.table("/shared/projects/multiwhaling/multiwhaling/data/VCF_maf_LD_Pruned.5.pca/VCF_maf_LD_Pruned.5.projections", header = F)
proj <- as_tibble(proj) |>
  dplyr::select(1:4) |>
  mutate(pop = names_ind |> arrange(Population))
saveRDS(proj, "/shared/projects/multiwhaling/multiwhaling/plot/PCA/projections_maf_LD_Pruned.5.RDS")

pdf(paste("/shared/projects/multiwhaling/multiwhaling/plot/PCA/PCA_all_pop_maf_LD_Pruned.5.pdf"))
proj |>
