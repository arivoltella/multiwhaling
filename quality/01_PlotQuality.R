...
## Save plots
png(paste0("plot/Quality/DistribDepth.png"), width = 500, height = 500)
print(g0)
dev.off()
png(paste0("plot/Quality/DepthPerSite.png"), width = 500, height = 500)
print(g1)
dev.off()
png(paste0("plot/Quality/DepthPerInd.png"), width = 500, height = 500)
print(g2)
dev.off()
png(paste0("plot/Quality/NAPerSite.png"), width = 500, height = 500)
print(g3)
dev.off()
png(paste0("plot/Quality/NAPerInd.png"), width = 500, height = 500)
print(g4)
dev.off()
png(paste0("plot/Quality/HetPerSite.png"), width = 500, height = 500)
print(g5)
dev.off()
png(paste0("plot/Quality/HetPerInd.png"), width = 500, height = 500)
print(g6)
dev.off()
png(paste0("plot/Quality/depth_by_pop.png"), width = 500, height = 500)
print(g7)
dev.off()
