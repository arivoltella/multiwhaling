...
plot_quality <- function(VCF){
  ...
  # -------------------------------------------------------------------------------------
  ################ Création des listes des noms d'indiv et pop associées ################
  # -------------------------------------------------------------------------------------
  ...
  names_ind <- names_ind |>
    ...
    mutate(pop = ifelse(pop == "A", "NATL",
                 ifelse(pop == "Ber", "BERING", 
                 ifelse(pop == "Chi", "CHILI", 
                 ifelse(pop == "Kar", "KARAGINSKY", 
                 ifelse(pop == "Pe", "PEROU",
                 ifelse(pop == "AN", "SATL", 
                 ifelse(pop == "MnD", "Maine",
                 ifelse(pop == "MnS", "Maine", "MADAGASCAR")))))))))
  
  #### Statistiques résumées liées à la POSITION #### -----------------------------------
  # -------------------------------------------------------------------------------------
